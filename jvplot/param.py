...
DEFAULT = {
    ...
    'axis_tick_spacing': ('dim', '2cm', 'optimal spacing for axis tick marks'),
    'axis_tick_spacing_x': ('dim', '$axis_tick_spacing', 'optimal spacing for x-axis tick marks'),
    'axis_tick_spacing_y': ('dim', '$axis_tick_spacing', 'optimal spacing for y-axis tick marks'),
    'axis_tick_lw': ('dim', 'inherit', 'line width for axis tick marks'),
    ...
    'margin_left': ('width', '16mm', 'axis left margin'),
    'margin_right': ('width', '1mm', 'axis right margin'),
    'margin_top': ('height', '1mm', 'axis top margin'),
    ...
    'rect_bg': ('col', '$bg_col', 'fill color for rectangles'),
    'rect_fg': ('col', '$fg_col', 'line color for rectangles'),
    'rect_lw': ('dim', '$lw_medium', 'line width for rectangles'),
